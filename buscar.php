            ...
            echo '
                <div class="w3-paddingw3-content w3-margin">
					...
					$sql = "SELECT * FROM publicacao pub INNER JOIN trabalho t ON pub.cod_trabalho = t.cod_trabalho
														 ...
														 LEFT OUTER JOIN palavra_chave_trabalho pct ON pct.cod_trabalho = t.cod_trabalho 
														 LEFT OUTER JOIN palavra_chave pc ON pc.cod_palavra_chave = pct.cod_palavra_chave
														 WHERE t.titulo_trabalho LIKE '".$pesquisa."' OR pc.palavra_chave LIKE '".$pesquisa."' 
														 GROUP BY t.cod_trabalho
														 ORDER BY ano_trabalho desc";
